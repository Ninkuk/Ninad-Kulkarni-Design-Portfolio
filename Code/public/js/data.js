...
const projects = [{
    ...
    },
    {
        ...
        "body": "As a class leader and mentor, I created the class site for Pinnacle High School's award-winning Graphic Design program.\n\nThis website is used by the course instructor along with senior students to promote the class to freshman and other prospective students during the club fair.\n\nThe site also showcases the projects and accomplishments of students that participate in CTE competitions on State and National stages.",
        "tags": ['html/css'],
        "url": ""
    },
    {
    ...
    },
    {
        ...
        "body": "Being in an Indian family where every member has a different style of making Chai Tea, I always forget the recipes and measurements of particular styles.\n\nSo I made an app where you can store the measurement of ingredients and take specific notes to refer back to.",
        "tags": ['android', 'kotlin'],
